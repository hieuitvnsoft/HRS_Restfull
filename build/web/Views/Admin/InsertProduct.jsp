<%-- 
    ...
    Created on : Jul 24, 2019, 10:39:17 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.7 -->
        <link rel="stylesheet" href="http://localhost:8080/HRS/Views/Admin/bower_components/bootstrap/dist/css/bootstrap.min.css">
        <!-- Font Awesome -->
        ...
        <!-- jvectormap -->
        <link rel="stylesheet" href="http://localhost:8080/HRS/Views/Admin/bower_components/jvectormap/jquery-jvectormap.css">
        <!-- Theme style -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div>   
                                    ...
                                    <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Nhà sản xuất</td>
                                                <td>
                                                    <spring:select path="producerId.producerId">
                                                       
                                                        <spring:options items="${listProducer}" itemLabel="producerName" itemValue="producerId"/>                                                       
                                                    </spring:select>
                                            ...
                                            <tr>
                                                <td>Danh mục</td>
                                                <td>
                                                    <spring:select path="subProductTypeId.subProductTypeId">
                                                       
                                                        <spring:options items="${listSub}" itemLabel="subProductTypeName" itemValue="subProductTypeId"/>                                                       
                                                    </spring:select>
                                ...
                                <div>
                                    <a  href="${pageContext.request.contextPath}/Admin/ds_sanpham.htm" value="">Về trang danh sách</a>
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
        ...
        <!-- jQuery 3 -->
        <script src="http://localhost:8080/HRS/Views/Admin/bower_components/jquery/dist/jquery.min.js"></script>
        <!-- Bootstrap 3.3.7 -->
