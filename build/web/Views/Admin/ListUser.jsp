                                ...
                                <table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Mã khách</th>
                                            <th style="width:100px;height:100px;text-align:center;">Tên khách</th>
                                            <th>Địa chỉ</th>
                                            <th>Email</th>
                                            <th>Ngày sinh</th>
                                            <th>Giới tính</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${listUser}" var="listU">
                                            <tr>
                                                ...
                                                <td style="width: 100px; text-align: center">${listU.userId}  </td>
                                                <td style="width: 200px;text-align: center"> ${listU.fullName}</td>
                                                <td style="width: 250px">${listU.address}</td>
                                                ...
                                                <c:if test="${listU.sex == 'True'}">
                                                    <td style="width: 200px">
                                                        Nam
                                                    </td>
                                                </c:if>
                                                <c:if test="${listU.sex == 'False'}">
                                                    <td style="width: 200px">
                                                        Nữ
                                                    </td>
                                                </c:if>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="blue" href="userDetail.htm?Id=${listU.userId}">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>
                                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                                        <a class="green" href="updateUser.htm?Id=${listU.userId}">
