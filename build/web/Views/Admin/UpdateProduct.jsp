                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="warning">${mess}</div>
                            <div>   
                                <spring:form action="${pageContext.request.contextPath}/Admin/Update.htm" commandName="productDetail" method="post" modelAttribute="product" enctype="multipart/form-data">
                                    <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                             <tr>
                                                <td>Id</td>
                                                <td>
                                                    <spring:input type="text" path="productId" readonly="true" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Tên sản phẩm</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <spring:input type="file" path="imgProduct"/> <img width="150px" src="/${product.imgProduct}"/>
