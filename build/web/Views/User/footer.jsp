<%-- 
    Document   : footer
    Created on : Jul 19, 2019, 12:05:24 AM
    Author     : Admin
--%>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3 col-md-3 col-xs-12">
                    <div class="footer-logo-area">
                        <a href="#"><img src="/HRS/Views/User/images/logo/logo-black.png" alt="footer logo"></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-6 col-md-6">
                    <p>Copyright © 2019 HieuRin.</p>
                </div>
                <div class="col-sm-12 col-lg-6 col-md-6 pull-right">
                    <img src="/HRS/Views/User/images/icons/payment-icon.png" alt="payment icon">
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="product-details-tab mr-40">
                                                <div class="product-details-large tab-content">
                                                    <div class="tab-pane active" id="pro-details1">
                                                        <div class="product-pop">
                                                            <a href="#">
                                                                <img src="/HRS/Views/User/images/product/single/product4.jpg" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="pro-details2">
                                                        <div class="product-pop">
                                                            <a href="#">
                                                                <img src="/HRS/Views/User/images/product/single/product5.jpg" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="pro-details3">
                                                        <div class="product-pop">
                                                            <a href="#">
                                                                <img src="/HRS/Views/User/images/product/single/product6.jpg" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="pro-details4">
                                                        <div class="product-pop">
                                                            <a href="#">
                                                                <img src="/HRS/Views/User/images/product/single/product7.jpg" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="pro-details5">
                                                        <div class="product-pop">
                                                            <a href="#">
                                                                <img src="/HRS/Views/User/images/product/single/product8.jpg" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="product-details-small nav product-dec-slider-qui owl-carousel">
                                                    <a class="active" href="#pro-details1">
                                                        <img src="/HRS/Views/User/images/product/thumbnails/product4.jpg" alt="">
                                                    </a>
                                                    <a href="#pro-details2">
                                                        <img src="/HRS/Views/User/images/product/thumbnails/product5.jpg" alt="">
                                                    </a>
                                                    <a href="#pro-details3">
                                                        <img src="/HRS/Views/User/images/product/thumbnails/product6.jpg" alt="">
                                                    </a>
                                                    <a href="#pro-details4">
                                                        <img src="/HRS/Views/User/images/product/thumbnails/product7.jpg" alt="">
                                                    </a>
                                                    <a href="#pro-details5">
                                                        <img src="/HRS/Views/User/images/product/thumbnails/product8.jpg" alt="">
                                                    </a>
                                                    <a class="active" href="#pro-details1">
                                                        <img src="/HRS/Views/User/images/product/thumbnails/product4.jpg" alt="">
                                                    </a>
