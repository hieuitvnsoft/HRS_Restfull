<%-- 
    Document   : sidebar
    Created on : Jul 18, 2019, 11:58:31 PM
    Author     : Admin
--%>
                ...
                <div class="slider-area-inner">
                    ...
                    <div class="slider-inner">
                        <div id="mainSlider" class="nivoSlider nevo-slider">
                            <img src="/HRS/Views/User/images/slider/1.jpg" alt="main slider" title="#htmlcaption1"/>
                            <img src="/HRS/Views/User/images/slider/2.jpg" alt="main slider" title="#htmlcaption2"/>
                        </div>	
            ...
            <div class="slider-banner-area col-sm-12">
                <div class="slider-banner">
                    <div class="slider-single-banner">
                        <a href="shop.html">
                            <img src="/HRS/Views/User/images/banner/banner1.jpg" alt="Banner">
                        </a>
                    </div>
                </div>
                <div class="slider-banner">
                    <div class="slider-single-banner">
                        <a href="shop.html">
                            <img src="/HRS/Views/User/images/banner/banner2.jpg" alt="Banner">
                        </a>
                    </div>
                </div>
            </div>
